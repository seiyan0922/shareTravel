...
<div class="body">
    <div class="side-bar">
        ...
        <div class="icon-common">
            <a href="/event/download?event_id={{.Id}}" class="member-add">
    ...
    <div class="event-content .clearfix">
        <div class="event-header">
            ...
            <div class="event-info">
                ...
                <div class="event-key">認証ID：{{.AuthKey}}</div>
            </div>

            <div class="event-top-tab">
                <ul>
                    <a class="tab-link" href="/event/show?event_id={{.Id}}">
                        <li class="tab-item">会計履歴</li>
                    </a>
                    <a class="tab-link" href="/event/indexMember?event_id={{.Id}}">
        ...
        <div class="event-main">
            <div>
                <form action="/event/edit?event_id={{.Id}}" method="POST">
                    <table class="">
                        <tr class="">
                            <td><label>認証ID</label></td>
                            <td>：<input type="text" name="auth_key" value="{{.AuthKey}}"></td>
                        </tr>
                        <tr class="">
                            <td class="">イベント名</td>
